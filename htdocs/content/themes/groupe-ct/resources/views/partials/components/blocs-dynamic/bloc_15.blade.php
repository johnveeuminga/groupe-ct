        ...
        @foreach($team['bloc_15_team_members'] as $member)
            ...
            <div class="team-info-container">
                ...
                <div class="team-info-inner-container">
                    <img class="team-info-img" src="{{ get_the_post_thumbnail_url($member['block_15_team_member'], 'full') }}" alt="{{ get_the_post_thumbnail_caption($member['block_15_team_member']) }}">
