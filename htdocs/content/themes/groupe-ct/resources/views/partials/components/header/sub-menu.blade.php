    ...
    <div class="sub-menu-container nl3 row hide-from-screen">
        ...
        <div class="nav-sub-container row">
            <nav class="nav-sub nav-sub-left col-xs-3 col-xs-offset-2">
                ...
                <ul class="nav-link-container">
                    <li class="menu-item"><a class="nav-link {{ PageHelper::get_page_id(PageHelper::PAGE_3_0_ASSISTANCE) === get_the_ID() ? 'scroll-to' : '' }}" data-target="#_section-01" href="{{ PageHelper::get_page_permalink(PageHelper::PAGE_3_0_ASSISTANCE) }}#section-01"><?= pll__('Accéder à Mon CT', GROUPE_CT) ?></a></li>
                    <li class="menu-item"><a class="nav-link {{ PageHelper::get_page_id(PageHelper::PAGE_3_0_ASSISTANCE) === get_the_ID() ? 'scroll-to' : '' }}" data-target="#_section-02" href="{{ PageHelper::get_page_permalink(PageHelper::PAGE_3_0_ASSISTANCE) }}#section-02"><?= pll__('Compléter une demande d\'assistance', GROUPE_CT) ?></a></li>
                    <li class="menu-item"><a class="nav-link {{ PageHelper::get_page_id(PageHelper::PAGE_3_0_ASSISTANCE) === get_the_ID() ? 'scroll-to' : '' }}" data-target="#_section-03" href="{{ PageHelper::get_page_permalink(PageHelper::PAGE_3_0_ASSISTANCE) }}#section-03"><?= pll__('Commander des fournitures', GROUPE_CT) ?></a></li>
                    <li class="menu-item"><a class="nav-link {{ PageHelper::get_page_id(PageHelper::PAGE_3_0_ASSISTANCE) === get_the_ID() ? 'scroll-to' : '' }}" data-target="#_section-04" href="{{ PageHelper::get_page_permalink(PageHelper::PAGE_3_0_ASSISTANCE) }}#section-04"><?= pll__('Contacter le service à la clientèle', GROUPE_CT) ?></a></li>
                    <li class="menu-item"><a class="nav-link {{ PageHelper::get_page_id(PageHelper::PAGE_3_0_ASSISTANCE) === get_the_ID() ? 'scroll-to' : '' }}" data-target="#_section-05" href="{{ PageHelper::get_page_permalink(PageHelper::PAGE_3_0_ASSISTANCE) }}#section-05"><?= pll__('Fournir une lecture de compteurs', GROUPE_CT) ?></a></li>
                </ul>
            </nav>
        </div>
    </div>
