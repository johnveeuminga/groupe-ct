<div class="bloc-contact-container default-padding default-width">
    ...
    <div class="contact-container">
        <div class="inner-container">
            ...
            <p class="contact-text">{!! nl2br('Contact a propos col 1') !!}</p>
    ...
    <div class="contact-container">
        <div class="inner-container">
            ...
            <p class="contact-text">{!! nl2br('Contact a propos col 2') !!}</p>
    ...
    <div class="contact-container">
        <div class="inner-container">
            ...
            <p class="contact-text">{!! nl2br('Contact a propos col 3') !!}</p>
