...
<div class="img-plus-text img-plus-text-normal default-padding default-width @if($block->get_field('bloc_3_image_left') === false) reverse-elem  @endif" id="_{{ $block->id }}">
    ...
    <div class="text-container">
        ...
        @if (!empty($block->get_field('bloc_3_text')))<p class="text">{!! nl2br($block->get_field('bloc_3_text')) !!}</p>@endif
