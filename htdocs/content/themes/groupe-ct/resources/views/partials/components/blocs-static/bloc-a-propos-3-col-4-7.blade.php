<div class="bloc-contact-container default-padding default-width static-4-7">
    ...
    <div class="contact-container">
        <div class="inner-container">
            ...
            <a class="contact-link-cta open-contact-form" href="#"><img class="contact-cta" src="{{ themosis_assets() }}/images/icon/icon-cta-arrow-white.png" alt=""></a>
        </div>
    </div>
    ...
    <div class="contact-container">
        <div class="inner-container">
            ...
            <a class="contact-link-cta" href="{{ PageHelper::get_page_permalink(PageHelper::PAGE_3_0_ASSISTANCE) }}#section-02"><img class="contact-cta" src="{{ themosis_assets() }}/images/icon/icon-cta-arrow-white.png" alt=""></a>
        </div>
    </div>
    ...
    <div class="contact-container">
        <div class="inner-container">
            ...
            <a class="contact-link-cta" href="{{ PageHelper::get_page_permalink(PageHelper::PAGE_3_0_ASSISTANCE) }}#section-03"><img class="contact-cta" src="{{ themosis_assets() }}/images/icon/icon-cta-arrow-white.png" alt=""></a>
        </div>
    </div>
