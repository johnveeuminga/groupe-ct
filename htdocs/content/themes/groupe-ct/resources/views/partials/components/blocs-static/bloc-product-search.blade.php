    ...
    <div class="bloc-product-container">
        ...
        <div class="nav-cat-main-container">
            <nav class="nav-cat-container default-padding default-width">
                ...
                <ul class="menu-item-container">
                    <li class="menu-item item-cat-active"><a class="primary-btn-blue-sky" href="#"><?php _e('Imprimante', THEME_TEXTDOMAIN); ?></a></li>
                    <li class="menu-item"><a class="primary-btn-blue-sky" href="#"><?php _e('Multifonction A4', THEME_TEXTDOMAIN); ?></a></li>
                    <li class="menu-item"><a class="primary-btn-blue-sky" href="#"><?php _e('Multifonction A3', THEME_TEXTDOMAIN); ?></a></li>
                    <li class="menu-item"><a class="primary-btn-blue-sky" href="#"><?php _e('Numérisateur', THEME_TEXTDOMAIN); ?></a></li>
                </ul>
            </nav>
