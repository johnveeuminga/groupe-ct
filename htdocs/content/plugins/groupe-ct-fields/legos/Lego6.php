...
class Lego6 extends BaseLego implements LegoInterface
{
    public function get_unique_fields()
    {
        return [
            ...
            $this->generate_image('bloc_6_2_icon', 'Icon', __('Icon', 'GROUPE-CT'), __('Width 125px | Height 125px', 'GROUPE-CT') ),
            ...
            $this->generate_image('bloc_6_3_icon', 'Icon', __('Icon', 'GROUPE-CT'), __('Width 125px | Height 125px', 'GROUPE-CT') ),
