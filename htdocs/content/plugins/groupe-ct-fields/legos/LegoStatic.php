	...
	public function get_unique_fields()
	{
		return [
			$this->generate_select('bloc_static_file', 'Bloc Static', [
			    ...
			    'form-support-technique-01-3-0' => 'Form Accéder à Mon CT - 3.0',
			    'form-support-technique-02-3-0' => 'Form Accéder à Mon CT - 3.0',
			    'form-support-technique-03-3-0' => 'Form Accéder à Mon CT - 3.0',
			    'form-support-technique-04-3-0' => 'Form Accéder à Mon CT - 3.0',
