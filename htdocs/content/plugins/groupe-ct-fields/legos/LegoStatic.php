	...
	public function get_unique_fields()
	{
		return [
			$this->generate_select('bloc_static_file', 'Bloc Static', [
			    ...
			    'bloc-tab-products-2-0' => 'Bloc gestion du changement - Produit et solution - 2.0',
			    'bloc-tab-products-2-1' => 'Bloc gestion du changement - Équipements d\'impression - 2.1',
			    'bloc-tab-products-2-2' => 'Bloc gestion du changement - Services d\'impression gérés - 2.2',
			    'bloc-tab-products-2-3' => 'Bloc gestion du changement - Gestion électronique des documents - 2.3',
